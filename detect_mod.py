...
from utils.dataloaders import IMG_FORMATS, VID_FORMATS, LoadImages, LoadScreenshots, LoadStreams, LoadImagesPIL
...
def run_detection(
    ...
    **_
    ...
    for idx, (img_id, im, im0s, _) in enumerate(dataset):
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/backup/exp4/weights/best.pt', help='model path or triton URL')
